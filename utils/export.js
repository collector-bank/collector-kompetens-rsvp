...
function sendEventParticipantListAsCsv(event, response) {
...
function eventParticipantListAsExcel(event) {
  const styles = {
    header: {
      fill: {
        fgColor: {
...
function sendEventParticipantListAsExcel(event, response) {
  const report = eventParticipantListAsExcel(event);
...
module.exports = {
  sendEventParticipantListAsCsv: sendEventParticipantListAsCsv,
  sendEventParticipantListAsExcel: sendEventParticipantListAsExcel,
  eventParticipantListAsExcel: eventParticipantListAsExcel
}